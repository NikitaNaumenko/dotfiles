...
local mode_color = function()
    local mode_colors = {
        [110] = nord_colors.green,
        [105] = nord_colors.blue,
        [99] = nord_colors.green,
        [116] = nord_colors.blue,
        [118] = nord_colors.purple,
        [22] = nord_colors.purple,
        [86] = nord_colors.purple,
        [82] = nord_colors.red1,
        [115] = nord_colors.red1,
        [83] = nord_colors.red1
    }
...
section.left[1] = {
  ViMode = {
    ...
    highlight = {one_dark_colors.bg, one_dark_colors.bg, "bold"}
  }
}
section.left[3] = {
  FileIcon = {
